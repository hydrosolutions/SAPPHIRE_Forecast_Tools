...
def create_api_result_item(
    site_code, station_type, values_data, station_id=None, station_name=None
):
    """
        ...
        full_values.append(
            {
                ...
                "timestamp_utc": v.get("timestamp_local", "").replace(
                    "+06:00", "+00:00"
                ),  # Mock UTC
                "value_code": "WDDA",
    ...
    return {
        ...
        "data": [{"variable_code": "WDDA", "unit": "m3/s", "values": full_values}],
    }
...
class TestPaginationBugRegression:
    ...
    def test_site_meteo_page1_hydro_page2_keeps_hydro_data(self):
        ...
        page1_results = [
            create_api_result_item(
                "99901", "meteo", [{"value": 15.5, "timestamp_local": "2024-01-15T08:00:00"}]
            ),
            # Other sites on page 1
            create_api_result_item(
                "99902", "hydro", [{"value": 100.0, "timestamp_local": "2024-01-15T08:00:00"}]
            ),
        ]
        ...
        page2_results = [
            create_api_result_item(
                "99901", "hydro", [{"value": 150.0, "timestamp_local": "2024-01-15T08:00:00"}]
            ),
        ]
    ...
    def test_site_hydro_page1_meteo_page2_keeps_hydro_data(self):
        ...
        page1_results = [
            create_api_result_item(
                "99901", "hydro", [{"value": 200.0, "timestamp_local": "2024-01-15T08:00:00"}]
            ),
        ]
        ...
        page2_results = [
            create_api_result_item(
                "99901", "meteo", [{"value": 20.0, "timestamp_local": "2024-01-15T08:00:00"}]
            ),
        ]
...
class TestDualTypeSiteClassification:
    ...
    def test_meteo_only_site_excluded(self):
        ...
        results = [
            ...
            create_api_result_item(
                "99901", "meteo", [{"value": 15.0, "timestamp_local": "2024-01-15T08:00:00"}]
            ),
            # Site 99902 has hydro data
            create_api_result_item(
                "99902", "hydro", [{"value": 200.0, "timestamp_local": "2024-01-15T08:00:00"}]
            ),
        ]
...
class TestMultiPageAggregation:
    ...
    def test_records_from_multiple_pages_aggregated(self):
        ...
        page1_results = [
            create_api_result_item(
                "99901", "hydro", [{"value": 100.0, "timestamp_local": "2024-01-15T08:00:00"}]
            ),
            create_api_result_item(
                "99902", "hydro", [{"value": 200.0, "timestamp_local": "2024-01-15T08:00:00"}]
            ),
        ...
        page2_results = [
            create_api_result_item(
                "99903", "hydro", [{"value": 300.0, "timestamp_local": "2024-01-15T08:00:00"}]
            ),
            create_api_result_item(
                "99904", "hydro", [{"value": 400.0, "timestamp_local": "2024-01-15T08:00:00"}]
            ),
        ]

        page3_results = [
            create_api_result_item(
                "99905", "hydro", [{"value": 500.0, "timestamp_local": "2024-01-15T08:00:00"}]
            ),
        ]
...
class TestEmptyAndEdgeCases:
    ...
    def test_all_meteo_returns_empty_dataframe(self):
        ...
        results = [
            ...
            create_api_result_item(
                "99902", "meteo", [{"value": 16.0, "timestamp_local": "2024-01-15T08:00:00"}]
            ),
        ]
