...
class TestStandardizeDateColumn:
    ...
    def test_standardize_date_normalizes_time(self):
        ...
        df = pd.DataFrame({"date": pd.to_datetime(["2024-01-01 15:30:45", "2024-01-02 23:59:59"])})
    ...
    def test_standardize_date_preserves_date(self):
        ...
        df = pd.DataFrame({"date": pd.to_datetime(["2024-01-15", "2024-06-20", "2024-12-31"])})
