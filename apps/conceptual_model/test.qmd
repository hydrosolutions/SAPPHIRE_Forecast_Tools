...
if (Sys.getenv("IN_DOCKER_CONTAINER")=="") {
  ...
  # setwd(here())
  setwd("/Users/adrian/Documents/GitHub/SAPPHIRE_Forecast_Tools/apps/conceptual_model")
  print(getwd())
  if (SAPPHIRE_OPDEV_ENV==TRUE) {
...
# Step 7: Hindcast and save  ####
  ...
  print(length(pentadal_days(forecast_date, forecast_date)))
  print(!(exists("start_date_hindcast")))
...
decadal_days(forecast_date, forecast_date)
  ...
  if ((length(decadal_days(forecast_date, forecast_date)) == 0) && !(exists("start_date_hindcast"))) {
    ...
    process_save_time_steps(decadal_steps, "pentad", start_date_hindcast, forecast_date, dir_Results, Basin_Info, forecast_statistics)
