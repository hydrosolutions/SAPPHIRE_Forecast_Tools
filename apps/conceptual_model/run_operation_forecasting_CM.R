...
for (Code in config$codes) {
  ...
  # print(pentadal_days(start_date_hindcast,end_date_hindcast))
  ...
  # } else if ((length(pentadal_days(start_date_hindcast, forecast_date)) == 0) && (exists("start_date_hindcast"))) {
  ...
  # # CASE: There was done hindcasting, but there is no decadal step in the hindcasting
  #   } else if ((length(decadal_days(start_date_hindcast, forecast_date)) == 0) && (exists("start_date_hindcast"))) {
