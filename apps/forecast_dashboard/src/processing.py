...
def add_predictor_dates(horizon, linreg_predictor, station, date):
    """
...
def get_best_models_for_station_and_pentad(horizon, horizon_in_year, horizon_value, forecasts_all, selected_station):
