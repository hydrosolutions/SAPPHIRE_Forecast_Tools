...
def _make_long_forecast_records(code, year, months, model_type="GBT", q50=120.0):
    ...
    for m in months:
        ...
        if m == 12:
            ...
            last_day = date(year, m + 1, 1).replace(day=1) - pd.Timedelta(days=1)
        records.append(
            {
                "horizon_type": "month",
                "horizon_value": m,
...
class TestReadMonthlyObservations:
    ...
    def test_multiple_months_multiple_stations(self):
        ...
        with patch("src.data_reader._read_daily_runoff_api") as mock_api:
            mock_api.return_value = daily
            result = read_monthly_observations(["15013", "15020"], 2023, 2023)
...
class TestReadMonthlyForecasts:
    ...
    def test_happy_path_reads_monthly_forecasts(self):
        ...
        api_df = _make_long_forecast_records("15013", 2023, [1, 2, 3], model_type="GBT", q50=120.0)
    ...
    def test_model_type_becomes_model_short(self):
        ...
        api_df = _make_long_forecast_records("15013", 2023, [1], model_type="SM_GBT", q50=100.0)
    ...
    def test_month_extracted_from_valid_from(self):
        ...
        api_df = _make_long_forecast_records("15013", 2023, [6], model_type="GBT", q50=100.0)
    ...
    def test_year_extracted(self):
        ...
        api_df = _make_long_forecast_records("15013", 2023, [3], model_type="GBT", q50=100.0)
    ...
    def test_multiple_models_preserved(self):
        ...
        df1 = _make_long_forecast_records("15013", 2023, [1], model_type="GBT", q50=100.0)
        df2 = _make_long_forecast_records("15013", 2023, [1], model_type="LR_Base", q50=110.0)
    ...
    def test_quantile_columns_preserved(self):
        ...
        api_df = _make_long_forecast_records("15013", 2023, [1], model_type="GBT", q50=120.0)
    ...
    def test_output_columns(self):
        """Verify output has the expected column set."""
        api_df = _make_long_forecast_records("15013", 2023, [1], model_type="GBT", q50=100.0)
