...
class TestHindcastStartDateIntegration:
    ...
    def test_one_gauge_start_is_last_date_plus_one(self, tmp_path):
        ...
        with patch.dict(
            ...
            result = get_hindcast_start_date_from_output("PENTAD", site_list=None)
    ...
    def test_new_gauge_with_env_default(self, tmp_path):
        ...
        with patch.dict(
            ...
            result = get_hindcast_start_date_from_output("PENTAD", site_list=["15013", "99999"])
    ...
    def test_all_new_gauges_returns_env_default(self, tmp_path):
        ...
        with patch.dict(
            ...
            result = get_hindcast_start_date_from_output("PENTAD", site_list=["99999"])
    ...
    def test_decad_mode_ignores_pentad_csv(self, tmp_path):
        ...
        with patch.dict(
            ...
            os.environ.pop("ieasyhydroforecast_START_DATE", None)
            result = get_hindcast_start_date_from_output("DECAD", site_list=None)
    ...
    def test_full_pipeline_csv_to_next_forecast_day(self, tmp_path):
        ...
        with patch.dict(
            ...
            os.environ.pop("ieasyhydroforecast_START_DATE", None)
            start_date = get_hindcast_start_date_from_output("PENTAD", site_list=None)
