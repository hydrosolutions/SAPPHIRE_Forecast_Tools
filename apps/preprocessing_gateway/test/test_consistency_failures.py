...
class TestSnowWriteReadParameterContract:
    ...
    def test_swe_write_type_matches_read_type(self, mock_sdo_client_class, mock_dg_client_class):
    ...
    @patch("dg_utils.SapphirePreprocessingClient")
    @patch("snow_data_operational.SapphirePreprocessingClient")
    def test_hs_write_type_matches_read_type(self, mock_sdo_client_class, mock_dg_client_class):
    ...
    @patch("dg_utils.SapphirePreprocessingClient")
    @patch("snow_data_operational.SapphirePreprocessingClient")
    def test_rof_write_type_matches_read_type(self, mock_sdo_client_class, mock_dg_client_class):
...
class TestSnowConsistencyDateMismatch:
    ...
    @patch("dg_utils.SapphirePreprocessingClient")
    @patch("snow_data_operational.SapphirePreprocessingClient")
    def test_csv_max_date_is_today_passes(self, mock_sdo_client_class, mock_dg_client_class):
...
class TestExceptionSwallowing:
    ...
    @patch("Quantile_Mapping_OP._check_meteo_consistency")
    @patch("Quantile_Mapping_OP._write_meteo_to_api")
    def test_consistency_exception_does_not_crash(self, mock_write, mock_check):
...
class TestMeteoConsistencyReanalysis:
    ...
    @patch("extend_era5_reanalysis.SapphirePreprocessingClient")
    def test_returns_false_on_different_meteo_type_data(self, mock_client_class):
