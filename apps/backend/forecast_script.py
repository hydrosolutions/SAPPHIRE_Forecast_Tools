...
if __name__ == "__main__":
    ...
    if day not in days :
        print(f"Today is {today}. No forecast will be run.")
        logging.info(f"Today is {today}. No forecast will be run.")
    ...
    ## Merge information from db_sites and config_all
    ...
    # TODO when stations are added to the tool, adapt this filter
    # Only keep stations that are in [15194, 16936]
    stations = [station for station in stations if station in ["15194", "16936"]]
