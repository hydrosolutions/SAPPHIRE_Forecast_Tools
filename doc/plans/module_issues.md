...
| ID | Title | Resolved | File |
|----|-------|----------|------|
| PP-040 | DECADE skill `n_pairs` starved on tjhm — **NOT a code defect** (sparse ML forecast archive from an interrupted backfill). Pairing-bug hypothesis refuted; proven end-to-end locally (fill archive → n_pairs 0-1→14-15, zero code change). Residual server work (finish tjhm ML archive + recalc) tracked in [`working/tajik_local_historical_backfill_plan.md`](working/tajik_local_historical_backfill_plan.md). | 2026-07-15 | [`archive/high_prio_gi_draft_pp_decadal_skill_metrics_starved_RESOLVED_2026-07-15.md`](issues/archive/high_prio_gi_draft_pp_decadal_skill_metrics_starved_RESOLVED_2026-07-15.md) |
