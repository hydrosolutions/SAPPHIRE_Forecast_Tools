...
*Last updated: 2026-07-14 — Added FD-018 (m0 bulletin card hydrates from the main panel's
target month instead of its own; split from `develop_ltf_monthly_horizon_value` Defect G).
