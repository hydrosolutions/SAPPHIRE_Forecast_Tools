...
| Decade ML skill starved despite data | Medium | Tracked separately in `doc/plans/issues/high_prio_gi_draft_pp_decadal_skill_metrics_starved.md`; do not block LR observed backfill on it. |
